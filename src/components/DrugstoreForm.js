const DrugstoreForm = (props)=>{
    ...
    return (
        ...
        <div className="answer flex flex-col">
          <label>აფთიაქი</label>
    <input type='text' className="p-2 m-2 border-2 rounded-xl drop-shadow-xl text-black text-center" onChange={(e)=>setDrugstoreInfo(e.target.value)}></input>
    <label > ვიზიტის დრო</label>
    <input type='text' className="p-2 m-2 border-2 rounded-xl drop-shadow-xl text-black text-center" onChange={(e)=>setVisitTime(e.target.value)}></input>
